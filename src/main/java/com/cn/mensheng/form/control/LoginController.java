...
import static com.cn.mensheng.form.constant.formconstant.USER_LOCK;
...
public class LoginController extends BaseController {
   ...
   private FormService formService;
	...
	public ModelAndView login(HttpServletRequest request, 	User user) {
		...
		if (dbUser == null) {
		...
		} else if (dbUser.getLocked() == USER_LOCK) {
			...
			String toUrl = (String)request.getSession().getAttribute(formconstant.LOGIN_TO_URL);
			request.getSession().removeAttribute(formconstant.LOGIN_TO_URL);
	...
	public String logout(HttpSession session) {
		session.removeAttribute(formconstant.USER_CONTEXT);
